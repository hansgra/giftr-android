...
import no.granum.android.giftr.views.wishlistitem.AddWishListItemActivity;
...
public class CameraFragment extends Fragment {
    ...
    private void saveScaledPhoto(byte[] data) {
        ...
        Bitmap mealImageScaled = Bitmap.createScaledBitmap(mealImage, 700, 700
                * mealImage.getHeight() / mealImage.getWidth(), true);
    ...
    private void addPhotoToMealAndReturn(ParseFile photoFile) {
        ((AddWishListItemActivity) getActivity()).getCurrentItem().setImage(
                photoFile);
